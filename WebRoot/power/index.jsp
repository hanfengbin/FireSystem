...
String admin=(String)session.getAttribute("StaffPermissions");
	if(username==null){
		response.sendRedirect(basePath+"power/login.html");  
	}
%>
...
<html>
  <head>
	...
	<link href="power/css/bootstrap.min.css" rel="stylesheet">
	<link href="power/css/bootstrap-responsive.min.css" rel="stylesheet">
	
	<link href="power/css/font-awesome.css" rel="stylesheet">
	<link href="power/css/style.css" rel="stylesheet">
	<link href="power/css/asyncbox.css" rel="stylesheet">
	<script src="power/js/jquery-1.7.2.min.js"></script>
  ...
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        ...
        <li><a id="but2"><i class="icon-bolt"></i><span>电源主机</span> </a> </li>
...
function showFloor(id, title, name){
  ...
  function updateFualtType(data){
      ...
      asyncbox.open({
          ...
          width:800,
          height:300,
          url:'power/faultType.html?type='+data
  ...
  function showFloor(buildid,canNo,name){
      ...
      asyncbox.open({
          ...
          width:1000,
          height:500,
          url:'power/data.html?canNo='+canNo+'&buildId='+buildid
          //url:www.w3school.com.cn/tiy/t.asp?f=html_table_test
      });
  };
  </script>

<script src="power/js/bootstrap.js"></script>
<script src="power/js/highcharts.js"></script>
<script src="power/js/index.js"></script>
<script src="power/js/asyncbox.js"></script>
<!-- <script src="js/Calendar3.js"></script> -->
<script src="power/js/map.js"></script>
