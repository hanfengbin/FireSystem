...
String admin=(String)session.getAttribute("StaffPermissions");
	if(username==null){
		response.sendRedirect(basePath+"firedoor/login.html");  
	}
%>
...
<html>
  <head>
	...
	<link href="firedoor/css/bootstrap.min.css" rel="stylesheet">
	<link href="firedoor/css/bootstrap-responsive.min.css" rel="stylesheet">
	
	<link href="firedoor/css/font-awesome.css" rel="stylesheet">
	<link href="firedoor/css/style.css" rel="stylesheet">
	<link href="firedoor/css/asyncbox.css" rel="stylesheet">
	<script src="firedoor/js/jquery-1.7.2.min.js"></script>
...
<div class="navbar navbar-fixed-top">
  <div class="navbar-inner">
    <div class="container">
		<a class="brand" href="index.html">消防防火门监控</a>
  ...
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        ...
        <li><a id="but2"><i class="icon-bolt"></i><span>防火门主机</span> </a> </li>
...
function showFloor(id, title, name){
  ...
  function updateFualtType(data){
      ...
      asyncbox.open({
          ...
          width:800,
          height:300,
          url:'firedoor/faultType.html?type='+data
  ...
  function showFloor(buildid,canNo,name){
      ...
      asyncbox.open({
          ...
          width:1000,
          height:500,
          url:'firedoor/data.html?canNo='+canNo+'&buildId='+buildid
          //url:www.w3school.com.cn/tiy/t.asp?f=html_table_test
      });
  };
...
<script src="firedoor/js/bootstrap.js"></script>
<script src="firedoor/js/highcharts.js"></script>
<script src="firedoor/js/index.js"></script>
<script src="firedoor/js/asyncbox.js"></script>
<!-- <script src="js/Calendar3.js"></script> -->
<script src="firedoor/js/map.js"></script>
