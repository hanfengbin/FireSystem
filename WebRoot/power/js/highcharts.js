...
(function () {
    ...
    L = {
        ...
        chart: {
            ...
            spacing: [10, 10, 15, 10],
            style: {
                fontFamily: '"微软雅黑","Lucida Grande", "Lucida Sans Unicode", Verdana, Arial, Helvetica, sans-serif',
                fontSize: "12px"
            },
                        ...
                        function (e) {
                            if (e !== "" || m.length === 1) {
                                ...
                                if (e !== " " && (n.appendChild(z.createTextNode(e)), o ? p.dx = 0 : p.x = i, w(n, p), !o && f && (!W && d && I(n, {
                                    ...
                                    for (var e = e.replace(/([^\^])-/g, "$1- ").split(" "), u, t, p = a._clipHeight, E = [], v = y(l || 16), s = 1; e.length || E.length;) delete a.bBox,
                                u = a.getBBox(),
                                t = u.width, !W && c.forExport && (t = c.measureSpanWidth(n.firstChild.data, a.styles)),
                                u = t > k, !u || e.length === 1 ? (e = E, E = [], e.length && (s++, p && s * v > p ? (e = ["..."], a.attr("title", a.textStr)) : (n = z.createElementNS(ya, "tspan"), w(n, {
                                    dy: v,
                                    x: i
    ...
    eb.prototype = {
        ...
        render: function () {
            ...
            if (B || f)
                if (a.minorTickInterval && !a.categories && n(a.getMinorTickPositions(),
                    function (b) {
    ...
    xb.prototype = {
        ...
        runPointActions: function (a) {
            ...
            if (d && this.options.tooltip.shared && (!g || !g.noSharedTooltip)) {
                ...
                h = c.length;
                for (i = 0; i < h; i++)
                    if (c[i].visible && c[i].options.enableMouseTracking !== !1 && !c[i].noSharedTooltip && c[i].tooltipPoints.length && (b = c[i].tooltipPoints[k]) && b.series) b._dist = M(k - b.clientX),
                j = J(j, b._dist),
                e.push(b);
        ...
        select: function (a, b) {
            ...
            c.firePointEvent(a ? "select" : "unselect", {
                ...
                function () {
                    ...
                    //原文为b||，此处的b为判断ctrl或shift按下，详情见highcharts.src12065行
                    //当b时,即ctrl或shift按下时可多选,而!b恰好相反,具体问wdj
                    !b || n(e.getSelectedPoints(),
                        function (a) {
    ...
    Q.prototype = {
        ...
        processData: function (a) {
            ...
            if (k && this.sorted && (!j || d > j || this.forceCrop))
                if (a = h.min, h = h.max, b[d - 1] < a || b[0] > h) b = [],
            c = [];
            ...
            n([b, "-" + b],
                function (b) {
                    ...
                    for (var e = a.xData.length,
                            f, g; e--;)
                        if (f = a.xData[e], d = (g = c[b] && c[b][f]) && g.points[a.index], f = d) g = g.total ? 100 / g.total : 0,
                    f[0] = ia(f[0] * g),
                    f[1] = ia(f[1] * g),
        ...
        drawPoints: function () {
            ...
            if (l.enabled || this._hasPointMarkers)
                for (f = b.length; f--;)
                    if (g = b[f], d = P(g.plotX), e = g.plotY, k = g.graphic, i = g.marker || {},
                        a = l.enabled && i.enabled === v || i.enabled, m = c.isInsidePlot(t(d), e, c.inverted), a && e !== v && !isNaN(e) && g.y !== null)
    ...
    G = ha(Q, {
        ...
        getSegmentPath: function (a) {
            ...
            if (e.stacking && !this.closedStacks)
                for (d = a.length - 1; d >= 0; d--) g = o(a[d].yBottom, f),
