...
$(document).ready(function(){
	...
	$("#but1").click(function(){
        ...
        $.ajax({
            ...
            data:{'controller':'TableItem','enum':'treeList'},
            dataType: "json",
	...
	$("#but2").click();
	switch($choose){
	case "node": $("#but3").click();break;
	case "host":$("#but2").click();break;
	case "fault":$("#but4").click();break;
	default:break;
	}
    $("#but2").click(function(){
    	$(".functionButton").remove();
        ...
        $('.widget-header i').removeClass().addClass("icon-list-alt");
        $('.widget-header h3').html('剩余电流主机详情');
        ...
        $.ajax({
            type: "post",
            url: "servlet/DispatchServlet",
            data:{'controller':'TableItem','enum':'1'},
            dataType: "json",
            success: function (simuData) {
            	//console.log(JSON.stringify(simuData));
        ...
        $("#pointShift2").click(function (){
            $.ajax({
                type: "post",
                url: "servlet/DispatchServlet",
                data:{'controller':'TableItem','enum':'3'},
                dataType: "json",
                success: function (simuData) {
                	//console.log(JSON.stringify(simuData));
                	var tableContent=simuData.tableItem.tableContent;
        ...
        $("#pointShift3").click(function (){
            $.ajax({
                type: "post",
                url: "servlet/DispatchServlet",
                data:{'controller':'TableItem','enum':'2'},
                dataType: "json",
                success: function (simuData) {
                	//console.log(JSON.stringify(simuData));
                	var tableContent=simuData.tableItem.tableContent;
    ...
    $("#but3").click(function(){
        ...
        $.ajax({
            type: "post",
            url: "servlet/DispatchServlet",
            data:{'controller':'TableItem','enum':'4'},
            dataType: "json",
            success: function (simuData) {
            	//console.log(JSON.stringify(simuData));
            	var tableContent=simuData.tableItem.tableContent;
        ...
        $("#pointShift2").click(function (){
            $.ajax({
                type: "post",
                url: "servlet/DispatchServlet",
                data:{'controller':'TableItem','enum':'6'},
                dataType: "json",
                success: function (simuData) {
                	//console.log(JSON.stringify(simuData));
                	var tableContent=simuData.tableItem.tableContent;
        ...
        $("#pointShift3").click(function (){
            $.ajax({
                type: "post",
                url: "servlet/DispatchServlet",
                data:{'controller':'TableItem','enum':'5'},
                dataType: "json",
                success: function (simuData) {
                	//console.log(JSON.stringify(simuData));
                	var tableContent=simuData.tableItem.tableContent;
    ...
    $("#but4").click(function(){
        ...
        $excelName='faultScreenByAppend3';
        ...
        $("#pointShift1").click(function (){
            $.ajax({
                type: "post",
                url: "servlet/DispatchServlet",
                data:{'controller':'FaultScreen','enum':'7','system':'3'},
                dataType: "json",
                success: function (simuData) {
                	console.log(JSON.stringify(simuData));
        ...
        $("#pointShift2").click(function (){
            $.ajax({
                type: "post",
                url: "servlet/DispatchServlet",
                data:{'controller':'FaultScreen','enum':'7','system':'3','mvfaultDealState':'未处置'},
                dataType: "json",
                success: function (simuData) {
                	console.log(JSON.stringify(simuData));
                	addJsonToTableFault(simuData, 'tableTbody');
        ...
        $("#pointShift3").click(function (){
            $.ajax({
                type: "post",
                url: "servlet/DispatchServlet",
                data:{'controller':'FaultScreen','enum':'7','system':'3','mvfaultDealState':'处置中'},
                dataType: "json",
                success: function (simuData) {
                	console.log(JSON.stringify(simuData));
                	addJsonToTableFault(simuData, 'tableTbody');
        ...
        $("#pointShift4").click(function (){
            $.ajax({
                type: "post",
                url: "servlet/DispatchServlet",
                data:{'controller':'FaultScreen','enum':'7','system':'3','mvfaultDealState':'已处置'},
                dataType: "json",
                success: function (simuData) {
                	console.log(JSON.stringify(simuData));
                	addJsonToTableFault(simuData, 'tableTbody');
    ...
    $("#but6").click(function(){
        ...
        $('#spanTable').removeClass().addClass('span12');
        $('.widget-header i').removeClass().addClass("icon-list-alt");
        $('.widget-header h3').html('剩余电流态势分析');
        $("#tableTbody tr").remove();
       ...
       $.ajax({
           type: "post",
           url: "servlet/DispatchServlet",
           data:{"controller":"ChartItem","enum":"faultStateDaysSubParas","paras":"3"},
           dataType: "json",
           success: function (simuData) {
        	   console.log(JSON.stringify(simuData));
     ...
     $.ajax({
            type: "post",
            url: "servlet/DispatchServlet",
            data:{'controller':'StatusController','system':'3','buildId':0},
            dataType: "json",
            success: function (simuData) {
...
function checkBuild(obj){
     ...
     $.ajax({
         type: "post",
         url: "servlet/DispatchServlet",
         data:{"controller":"ChartItem","enum":$enum,"paras":"3"+$para+$obj},
         dataType: "json",
         success: function (simuData) {
      	   console.log(JSON.stringify(simuData));
      	   chartSimuData=simuData.chartItem.data;
