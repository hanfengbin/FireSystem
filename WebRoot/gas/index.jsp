...
String admin=(String)session.getAttribute("StaffPermissions");
	if(username==null){
		response.sendRedirect(basePath+"gas/login.html");  
	}
%>
...
<div class="navbar navbar-fixed-top">
  <div class="navbar-inner">
    <div class="container">
		<a class="brand" href="index.html">消防气体监控</a>
  ...
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        ...
        <li><a id="but2"><i class="icon-bolt"></i><span>气体监控主机</span> </a> </li>
...
function showFloor(id, title, name){
  ...
  function updateFualtType(data){
      ...
      asyncbox.open({
          ...
          width:800,
          height:300,
          url:'gas/faultType.html?type='+data
  ...
  function showFloor(buildid,canNo,name){
      ...
      asyncbox.open({
          ...
          width:1000,
          height:500,
          url:'gas/data.html?canNo='+canNo+'&buildId='+buildid
          //url:www.w3school.com.cn/tiy/t.asp?f=html_table_test
      });
  };
...
<script src="gas/js/bootstrap.js"></script>
<script src="gas/js/highcharts.js"></script>
<script type="text/javascript" src="../public/default.js"></script>
<script src="gas/js/index.js"></script>
<script src="gas/js/asyncbox.js"></script>
<!-- <script src="js/Calendar3.js"></script> -->
<script src="gas/js/map.js"></script>
