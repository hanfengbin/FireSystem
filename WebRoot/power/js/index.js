...
$(document).ready(function(){
	...
	$("#but1").click(function(){
        ...
        $.ajax({
            ...
            data:{'controller':'TableItem','enum':'treeList5'},
            dataType: "json",
    ...
    $("#but2").click(function(){
        ...
        $('.widget-header i').removeClass().addClass("icon-list-alt");
        $('.widget-header h3').html('消防电源主机详情');
        ...
        $.ajax({
            type: "post",
            url: "servlet/DispatchServlet",
            data:{'controller':'TableItem','enum':'hostList5'},
            dataType: "json",
            success: function (simuData) {
            	//console.log(JSON.stringify(simuData));
        ...
        $("#pointShift2").click(function (){
            $.ajax({
                type: "post",
                url: "servlet/DispatchServlet",
                data:{'controller':'TableItem','enum':'hostListNormal5'},
                dataType: "json",
                success: function (simuData) {
                	//console.log(JSON.stringify(simuData));
                	var tableContent=simuData.tableItem.tableContent;
        ...
        $("#pointShift3").click(function (){
            $.ajax({
                type: "post",
                url: "servlet/DispatchServlet",
                data:{'controller':'TableItem','enum':'hostListFault5'},
                dataType: "json",
                success: function (simuData) {
                	//console.log(JSON.stringify(simuData));
                	var tableContent=simuData.tableItem.tableContent;
    ...
    $("#but3").click(function(){
        ...
        $.ajax({
            type: "post",
            url: "servlet/DispatchServlet",
            data:{'controller':'TableItem','enum':'nodeList5'},
            dataType: "json",
            success: function (simuData) {
            	//console.log(JSON.stringify(simuData));
            	var tableContent=simuData.tableItem.tableContent;
        ...
        $("#pointShift2").click(function (){
            $.ajax({
                type: "post",
                url: "servlet/DispatchServlet",
                data:{'controller':'TableItem','enum':'nodeListNormal5'},
                dataType: "json",
                success: function (simuData) {
                	//console.log(JSON.stringify(simuData));
                	var tableContent=simuData.tableItem.tableContent;
        ...
        $("#pointShift3").click(function (){
            $.ajax({
                type: "post",
                url: "servlet/DispatchServlet",
                data:{'controller':'TableItem','enum':'nodeListFault5'},
                dataType: "json",
                success: function (simuData) {
                	//console.log(JSON.stringify(simuData));
                	var tableContent=simuData.tableItem.tableContent;
    ...
    $("#but4").click(function(){
        ...
        $excelName='faultScreenByAppend5';
        ...
        $("#pointShift1").click(function (){
            $.ajax({
                type: "post",
                url: "servlet/DispatchServlet",
                data:{'controller':'FaultScreen','enum':'7','system':'5'},
                dataType: "json",
                success: function (simuData) {
                	console.log(JSON.stringify(simuData));
        ...
        $("#pointShift2").click(function (){
            $.ajax({
                type: "post",
                url: "servlet/DispatchServlet",
                data:{'controller':'FaultScreen','enum':'7','system':'5','mvfaultDealState':'未处置'},
                dataType: "json",
                success: function (simuData) {
                	console.log(JSON.stringify(simuData));
                	addJsonToTableFault(simuData, 'tableTbody');
        ...
        $("#pointShift3").click(function (){
            $.ajax({
                type: "post",
                url: "servlet/DispatchServlet",
                data:{'controller':'FaultScreen','enum':'7','system':'5','mvfaultDealState':'处置中'},
                dataType: "json",
                success: function (simuData) {
                	console.log(JSON.stringify(simuData));
                	addJsonToTableFault(simuData, 'tableTbody');
        ...
        $("#pointShift4").click(function (){
            $.ajax({
                type: "post",
                url: "servlet/DispatchServlet",
                data:{'controller':'FaultScreen','enum':'7','system':'5','mvfaultDealState':'已处置'},
                dataType: "json",
                success: function (simuData) {
                	console.log(JSON.stringify(simuData));
                	addJsonToTableFault(simuData, 'tableTbody');
    ...
    $("#but6").click(function(){
        ...
        $('#spanTable').removeClass().addClass('span12');
        $('.widget-header i').removeClass().addClass("icon-list-alt");
        $('.widget-header h3').html('消防电源态势分析');
        $("#tableTbody tr").remove();
       ...
       $.ajax({
           type: "post",
           url: "servlet/DispatchServlet",
           data:{"controller":"ChartItem","enum":"faultStateDaysSubParas","paras":"5"},
           dataType: "json",
           success: function (simuData) {
        	   console.log(JSON.stringify(simuData));
     ...
     $.ajax({
            type: "post",
            url: "servlet/DispatchServlet",
            data:{'controller':'StatusController','system':'5','buildId':0},
            dataType: "json",
            success: function (simuData) {
    ...
    $('#logout').click(function(){
		$.ajax({
            ...
            success: function (simuData) {
            	if((simuData=="success")){
            		alert("注销成功");
            		window.location.href="power/login.html";
            	}
            },
        });	
	});
...
function addJsonToTableFault(jsonData,tableId){
	    ...
	    for(var numRow in tableContent){//存入表格数据
	        ...
	        if(rowContent[2]=='主机异常'){
	        	...
	        	row+='<td>'+' <div class=\"badge\" onclick=\"updateFualtType(\''+ rowContent[i] +'\')\"'+' id=\"'+rowContent[i]+'\">'+'详情'+'</div>'+'</td>';
	        }
	        row+="</tr>";
	        pageContent[array]+=row;
	        //console.log(row);
...
function checkBuild(obj){
	  ...
	  $.ajax({
        type: "post",
        url: "servlet/DispatchServlet",
        data:{'controller':'StatusController','system':'5','buildId':obj.value},
        dataType: "json",
        success: function (message) {
            $('#host td').remove();
            $('#node td').remove();
     ...
     $.ajax({
         type: "post",
         url: "servlet/DispatchServlet",
         data:{"controller":"ChartItem","enum":$enum,"paras":"5"+$para+$obj},
         dataType: "json",
         success: function (simuData) {
      	   console.log(JSON.stringify(simuData));
      	   chartSimuData=simuData.chartItem.data;
