...
$(document).ready(function(){
	...
	$("#but1").click(function(){
        ...
        $.ajax({
            ...
            data:{'controller':'TableItem','enum':'treeList6'},
            dataType: "json",
                    	...
                    	if($dev[2]!=null){
                    		$('#accordion-element-'+$dev[0]+' .tree #treeParent').append('<li id="host'+$dev[2]+'"><a>'+$dev[3]+'</a></li>');
                        		if($dev[4]!=null){
                            		...
                            		$('#accordion-element-'+$dev[0]+' #host'+$dev[2]+' ul').append('<li><a id="'+$dev[4]+'" onclick="showFloor(\''+$dev[0]+'\',\''+$dev[2]+$dev[4]+'-'+$dev[5]+'\',\''+$dev[1]+$dev[3]+'总线'+$dev[4]+'\')">'+'总线'+$dev[4]+'</a></li>');                                    		
                        		}
                    		}
                    }else{
    ...
    $("#but2").click(function(){
        ...
        $('.widget-header i').removeClass().addClass("icon-list-alt");
        $('.widget-header h3').html('气体监控主机详情');
        ...
        $.ajax({
            type: "post",
            url: "servlet/DispatchServlet",
            data:{'controller':'TableItem','enum':'hostList6'},
            dataType: "json",
            success: function (simuData) {
            	//console.log(JSON.stringify(simuData));
        ...
        $("#pointShift2").click(function (){
            $.ajax({
                type: "post",
                url: "servlet/DispatchServlet",
                data:{'controller':'TableItem','enum':'hostListNormal6'},
                dataType: "json",
                success: function (simuData) {
                	//console.log(JSON.stringify(simuData));
                	var tableContent=simuData.tableItem.tableContent;
        ...
        $("#pointShift3").click(function (){
            $.ajax({
                type: "post",
                url: "servlet/DispatchServlet",
                data:{'controller':'TableItem','enum':'hostListFault6'},
                dataType: "json",
                success: function (simuData) {
                	//console.log(JSON.stringify(simuData));
                	var tableContent=simuData.tableItem.tableContent;
    ...
    $("#but3").click(function(){
        ...
        $.ajax({
            type: "post",
            url: "servlet/DispatchServlet",
            data:{'controller':'TableItem','enum':'nodeList6'},
            dataType: "json",
            success: function (simuData) {
            	//console.log(JSON.stringify(simuData));
            	var tableContent=simuData.tableItem.tableContent;
        ...
        $("#pointShift2").click(function (){
            $.ajax({
                type: "post",
                url: "servlet/DispatchServlet",
                data:{'controller':'TableItem','enum':'nodeListNormal6'},
                dataType: "json",
                success: function (simuData) {
                	//console.log(JSON.stringify(simuData));
                	var tableContent=simuData.tableItem.tableContent;
        ...
        $("#pointShift3").click(function (){
            $.ajax({
                type: "post",
                url: "servlet/DispatchServlet",
                data:{'controller':'TableItem','enum':'nodeListFault6'},
                dataType: "json",
                success: function (simuData) {
                	//console.log(JSON.stringify(simuData));
                	var tableContent=simuData.tableItem.tableContent;
    ...
    $("#but4").click(function(){
        ...
        $("#pointShift1").click(function (){
            $.ajax({
                type: "post",
                url: "servlet/DispatchServlet",
                data:{'controller':'FaultScreen','enum':'faultScreenByAppend','system':'6'},
                dataType: "json",
                success: function (simuData) {
                	console.log(JSON.stringify(simuData));
        ...
        $("#pointShift2").click(function (){
            $.ajax({
                type: "post",
                url: "servlet/DispatchServlet",
                data:{'controller':'FaultScreen','enum':'faultScreenByAppend','system':'6','mvfaultDealState':'未处置'},
                dataType: "json",
                success: function (simuData) {
                	console.log(JSON.stringify(simuData));
                	addJsonToTableFault(simuData, 'tableTbody');
        ...
        $("#pointShift3").click(function (){
            $.ajax({
                type: "post",
                url: "servlet/DispatchServlet",
                data:{'controller':'FaultScreen','enum':'faultScreenByAppend','system':'6','mvfaultDealState':'处置中'},
                dataType: "json",
                success: function (simuData) {
                	console.log(JSON.stringify(simuData));
                	addJsonToTableFault(simuData, 'tableTbody');
        ...
        $("#pointShift4").click(function (){
            $.ajax({
                type: "post",
                url: "servlet/DispatchServlet",
                data:{'controller':'FaultScreen','enum':'faultScreenByAppend','system':'6','mvfaultDealState':'已处置'},
                dataType: "json",
                success: function (simuData) {
                	console.log(JSON.stringify(simuData));
                	addJsonToTableFault(simuData, 'tableTbody');
    ...
    $("#but6").click(function(){
       ...
       $.ajax({
           type: "post",
           url: "servlet/DispatchServlet",
           data:{"controller":"ChartItem","enum":"faultStateDaysSubParas","paras":"6"},
           dataType: "json",
           success: function (simuData) {
        	   console.log(JSON.stringify(simuData));
     ...
     $.ajax({
            type: "post",
            url: "servlet/DispatchServlet",
            data:{'controller':'StatusController','system':'6','buildId':0},
            dataType: "json",
            success: function (simuData) {
...
function addJsonToTableFault(jsonData,tableId){
	    ...
	    for(var numRow in tableContent){//存入表格数据
	        ...
	        if(rowContent[2]=='主机异常'){
	        	var hostFaultType="";
	        	var faultCode=["探测器通信故障","主机备电故障","主机主电故障"];
	        	var code=rowContent[i].toString(2);
	        	for(i=code.length-1,j=2;i>=0&&j>=0;i--,j--){
	        		if(code.charAt(i)=='1'){
	        			hostFaultType=faultCode[j]+"、";
	        		}
	        	}
	        	console.log("主机异常类型"+hostFaultType);
	        	if(hostFaultType!=""){
	        		hostFaultType=hostFaultType.substring(0,hostFaultType.length-1);
	        	}
	        	row+='<td>'+' <div class=\"badge\" id=\"'+rowContent[i]+'\">'+hostFaultType+'</div>'+'</td>';
	        }else{
	        	 row+='<td>'+' <div class=\"badge\" onclick=\"updateFualtType(\''+ rowContent[0]+','+rowContent[i] +'\')\"'+' id=\"'+rowContent[i]+'\">'+'详情'+'</div>'+'</td>';
	        }     
	        row+="</tr>";
	        pageContent[array]+=row;
	        //console.log(row);
...
function checkBuild(obj){
	  ...
	  $.ajax({
        type: "post",
        url: "servlet/DispatchServlet",
        data:{'controller':'StatusController','system':'6','buildId':obj.value},
        dataType: "json",
        success: function (message) {
            $('#host td').remove();
            $('#node td').remove();
     ...
     $.ajax({
         type: "post",
         url: "servlet/DispatchServlet",
         data:{"controller":"ChartItem","enum":$enum,"paras":"6"+$para+$obj},
         dataType: "json",
         success: function (simuData) {
      	   console.log(JSON.stringify(simuData));
      	   chartSimuData=simuData.chartItem.data;
