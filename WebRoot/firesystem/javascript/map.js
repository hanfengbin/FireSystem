								...
								.addEventListener(
										...
										function(e) {
											$
													.ajax({
														url: "servlet/DispatchServlet",
										                data:{'controller':'StatusController','system':'0','buildId':marker.id},
														type : "post",
														dataType : "json",
														success : function(data) {
															...
															allStr = allStr
																	...
																	+ nodeFaultString
																	+ '</br>';
															var photoStr = 'firesystem/images/'+marker.id+'headnew.png';
															var pidPhotoStr = 'firesystem/images/'+marker.id+'rightnew.png';
